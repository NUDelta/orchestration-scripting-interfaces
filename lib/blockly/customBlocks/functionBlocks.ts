...
Blockly.Blocks["every"] = {
  init: function () {
    ...
    this.appendValueInput("action").setCheck(null).appendField("(input: action)");
...
Blockly.Blocks["contains"] = {
  init: function () {
    this.appendValueInput("NAME").setCheck(null).appendField("            Does (resource 1)");
    this.appendDummyInput().appendField("Contain");
    this.appendValueInput("blah").setCheck(null).appendField("                     (text)?");
    this.appendDummyInput("output: true or false").appendField("(output: true or false)");
...
Blockly.Blocks["tf_slack_message"] = {
  init: function () {
    ...
    this.appendValueInput("message").setCheck(null).appendField("(input: message to send)");
    this.appendValueInput("time").setCheck(null).appendField("(input: time to send)");
    this.appendValueInput("message").setCheck(null).appendField("(input: recipient)");
    this.appendDummyInput("output: recipient responded true or false").appendField(
...
Blockly.Blocks["slack_message"] = {
  init: function () {
    ...
    this.appendDummyInput().appendField(new Blockly.FieldTextInput("type name"), "NAME");
    this.appendDummyInput().appendField("asking ");
    this.appendDummyInput().appendField(new Blockly.FieldTextInput("type question"), "NAME1");
    this.appendDummyInput()
    ...
    this.setInputsInline(false);
    this.appendDummyInput().appendField(", then check if this message contains: ");
    this.appendDummyInput().appendField(new Blockly.FieldTextInput("type keyword"), "NAME2");
    /*
...
Blockly.Blocks["timestamp"] = {
  init: function () {
    this.appendDummyInput().appendField("Timestamps when updated(output: list of timestamps)");
    this.appendDummyInput().appendField("(output: list of timestamps)");
    this.appendValueInput("resource").setCheck(null).appendField("(input: resource)");
    this.appendValueInput("start").setCheck(null).appendField("(input: start time)");
    this.appendValueInput("end").setCheck("time").appendField("(input: end time)");
...
Blockly.Blocks["distinct"] = {
  init: function () {
    ...
    this.appendValueInput("list").setCheck("list").appendField("(input: list of timestamps)");
...
Blockly.Blocks["filled"] = {
  init: function () {
    ...
    this.appendValueInput("NAME").setCheck(null).appendField("(input: resource)");
