...
Blockly.Blocks["github3"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Github")
      .appendField(new Blockly.FieldDropdown([["working on tech", "working on tech"]]), "NAME");
...
Blockly.Blocks["high_deliverables"] = {
  init: function () {
    this.appendDummyInput().appendField("No deliverables attached in slack thread");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour(290);
    this.setTooltip("");
...
Blockly.Blocks["end_of_quarter_goal"] = {
  init: function () {
    ...
    this.appendDummyInput().appendField(new Blockly.FieldTextInput("type keyword"), "NAME1");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour("#0066cc");
    this.setTooltip("");
...
Blockly.Blocks["high_sprint_log_contains"] = {
  init: function () {
    ...
    this.appendDummyInput().appendField(new Blockly.FieldTextInput("type here!"), "NAME");
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour("#0066cc");
    this.setTooltip("");
...
Blockly.Blocks["at"] = {
  init: function () {
    this.appendValueInput("At").setCheck(null).setAlign(Blockly.ALIGN_RIGHT).appendField("At");
...
Blockly.Blocks["github_subcategory"] = {
  init: function () {
    this.appendDummyInput().appendField("-----------------GITHUB----------------");
    this.setColour("#000000");
    this.setTooltip("");
    this.setHelpUrl("");
  },
...
Blockly.Blocks["sprint_log_subcategory"] = {
  init: function () {
    this.appendDummyInput().appendField("-----------------SPRINT_LOG----------------");
    this.setColour("#000000");
    this.setTooltip("");
    this.setHelpUrl("");
  },
...
Blockly.Blocks["canvas_subcategory"] = {
  init: function () {
    this.appendDummyInput().appendField("-----------------CANVAS----------------");
    this.setColour("#000000");
    this.setTooltip("");
    this.setHelpUrl("");
  },
...
Blockly.Blocks["slack_subcategory"] = {
  init: function () {
    this.appendDummyInput().appendField("-----------------SLACK----------------");
    this.setColour("#000000");
    this.setTooltip("");
    this.setHelpUrl("");
  },
