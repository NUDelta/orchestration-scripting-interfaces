...
Blockly.Blocks["if"] = {
  init: function () {
    ...
    this.appendDummyInput().appendField("[reminder: you can break down your situation");
...
Blockly.Blocks["then"] = {
  init: function () {
    ...
    this.appendDummyInput().appendField(new Blockly.FieldTextInput("type suggestion"), "NAME1");
    this.setOutput(false);
    this.appendDummyInput()
