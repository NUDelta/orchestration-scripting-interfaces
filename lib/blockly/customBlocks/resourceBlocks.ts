    ...
    this.appendDummyInput()
      ...
      .appendField(
        new Blockly.FieldDropdown([
          ["module -> topic (output: string)", "module -> topic (output: string)"],
          ["module -> Type (output: string)", "module -> Type (output: string)"],
          ["module -> description (output: string)", "module -> description (output: string)"],
          ["module -> read? (output: boolean)", "module -> read? (output: boolean)"],
          ["module -> understood? (output: boolean)", "module -> understood? (output: boolean)"],
          ["module -> applied? (output: boolean)", "module -> applied? (output: boolean)"],
          ["module -> questions (output: string)", "module -> questions (output: string)"],
        ]),
        "NAME"
      );
...
Blockly.Blocks["student response to slack bot"] = {
  init: function () {
    ...
    this.appendValueInput("message").setCheck("String").appendField("(input: slack bot name)");
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new Blockly.FieldDropdown([
          ...
          ["Planning view -> Focus for sprint", "Planning view -> Focus for sprint"],
          ["Planning view -> What we learned", "Planning view -> What we learned"],
          ...
          ["section 6: conceptual contribution", "section 6: conceptual contribution"],
          ["section 7: technical contribution", "section 7: technical contribution"],
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new Blockly.FieldDropdown([
          ...
          ["What skill/expertise one looks for", "What skill/expertise one looks for"],
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new Blockly.FieldDropdown([
          ...
          ["Planning view -> Focus for sprint", "Planning view -> Focus for sprint"],
          ["Planning view -> What we learned", "Planning view -> What we learned"],
          ["section 1: identify a design situation", "section 1: identify a design situation"],
          ["section 2: test if a design problem", "section 2: test if a design problem"],
          ["section 3: describe broader impact", "section 3: describe broader impact"],
          ["section 4-7: design arguments", "section 4-7: design arguments"],
          ["section 8-9: check your design arguments", "section 8-9: check your design arguments"],
          ["section 10: interface arguments", "section 10: interface arguments"],
          ...
          ["section 15a: study setup (participants)", "section 15a: study setup (participants)"],
          ["section 15b: study setup (scenario)", "section 15b: study setup (scenario)"],
          ["section 16: data collection", "section 16: data collection"],
          ["section 17: core findings", "section 17: core findings"],
          ["section 18: design implications", "section 18: design implications"],
        ]),
        "NAME"
      );
    this.setInputsInline(false);
...
Blockly.Blocks["lip_signup"] = {
  init: function () {
    this.appendDummyInput()
      ...
      .appendField(
        new Blockly.FieldDropdown([
          ["which learning module they signed up for", "which learning module they signed up for"],
        ])
      );
    this.appendDummyInput().appendField(
      new Blockly.FieldDropdown([
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new Blockly.FieldDropdown([
          ...
          ["burndown (hours spent / points required)", "burndown (hours spent / points required"],
        ]),
        "NAME"
      );
...
javascriptGenerator["detection triggered - mentor wants response triggered (true or false)"] =
  function (block) {
    return "...";
  };
