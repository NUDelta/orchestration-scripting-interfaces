            ...
            >
              <Carousel.Slide>
                <div className={styles.guideStep}>
                  ...
                  <p className={styles.guideDescription}>
                    ...
                    --> send message to you that provide 1. suggestions for root causes 2. context information to 
                    help you diagnose the cause of the problem
                    <br></br>--> you select a root cause by replying to the message
              ...
              <Carousel.Slide ml={100}>
                <div className={styles.guideStep}>
                  ...
                  <p className={styles.guideDescription}>
                    A general script consists of 4 parts: <b>Scope, Detector, Message Constructor, and
                    Strategies.</b> <br></br><br></br>
                    Let's first define the scope of this script!
                    Who do you want this script to apply for? Is it a specific
                    SIG? Is it all projects?<br></br>
                    You will specify your
                    scope by attaching a "Scope" block to the "I want this
                    script to apply to" block. <br></br>
                    <b>Take a look at the "Scope" blocks under Social Structures</b>
                  </p>
                </div>
              </Carousel.Slide>
              <Carousel.Slide>
                <div className={styles.guideStep}>
                  ...
                  <p className={styles.guideDescription}>
                    ...
                    Use the Detector to detect the general situation (not root causes).
                    Don't worry about detecting any root causes in the detector! You will do that in the next step.{' '}
                    {/* <em>
              ...
              <Carousel.Slide>
                <div className={styles.guideStep}>
                  ...
                  <p className={styles.guideDescription}>
                    ...
                    <br></br>
                    You can customize your own message under the yellow "Construct Message" block, adding situation name, root causes,
                    context, memo to yourself etc..{' '}<br></br>
                    For each root causes, first enter a description, then some context information that you would like to know to help you diagnose the situation. 
                    <i>e.g. you can use data from the tools (check under "Sprint" "Canvases") or use a text block to write a memo to yourself to remind you to ask further about the issue!</i>
                  </p>
                </div>
              </Carousel.Slide>
              <Carousel.Slide>
